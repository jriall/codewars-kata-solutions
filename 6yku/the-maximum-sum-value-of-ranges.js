// https://www.codewars.com/kata/the-maximum-sum-value-of-ranges-simple-version/train/javascript
...
function maxSum(arr,range){
  return Math.max(...range.map((a,i)=>arr.reduce((b,c,i)=>i>=a[0] && i<=a[1] ? b+arr[i] : b,0)));
}